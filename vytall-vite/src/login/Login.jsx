...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#d8e9f6]"> {/* Softer background */}
      <div className="bg-white shadow-2xl rounded-3xl p-10 w-full max-w-sm"> {/* Changed from max-w-md to max-w-sm */}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="block mx-auto min-w-[160px] bg-[#7fb5e7] text-white p-3 rounded-full font-semibold hover:bg-[#6aa3db] transition-colors"
          >
            Log In
          </button>
        </form>
