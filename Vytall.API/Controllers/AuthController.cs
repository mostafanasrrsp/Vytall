...
public class AuthController : ControllerBase
{
    ...
    {
        new User { Id = 1, Username = "physician1", PasswordHash = "somehash", Role = "Physician", PhysicianId = 3 },
        ...
        new User { Id = 4, Username = "patient1", PasswordHash = "somehash", Role = "Patient", PatientId = 4 },
        new User { Id = 5, Username = "facility1", PasswordHash = "somehash", Role = "Facility", FacilityId = 1 },
        new User { Id = 6, Username = "warehouse1", PasswordHash = "somehash", Role = "Warehouse", WarehouseId = 1 }
    };
