  ...
  const loadMedicationData = async () => {
    try {
      ...
      prescriptions.forEach(prescription => {
        ...
        const adherenceRate = (prescription.dosesTaken / prescription.totalDoses) * 100;
        
        // Count adherence levels
        ...
        const medicationType = prescription.medicationDetails.split(' ')[0]; // Get first word as type
